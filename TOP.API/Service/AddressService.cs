...
namespace TOP.API.Service
{
    public class AddressService : IModelService<Address>
    {
        ...
        {
            var address = _topContext.Addresses.FirstOrDefault(x => x.address == addressParam.address);
        ...
        {
            var address = _topContext.Addresses.FirstOrDefault(x => x.Id == addressId);
        ...
        {
            var address = _topContext.Addresses.FirstOrDefault(x => x.address == name);
        ...
        {
            var dbAddress = _topContext.Addresses.FirstOrDefault(x => x.Id == address.Id);
